...
- [Safari browser scroll layout](safari-scroll-layout.md) — browser uses document scrolling; standalone uses one bounded scroller, with a fixed viewport-height desktop rail.
