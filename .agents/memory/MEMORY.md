...
- [Safari browser scroll layout](safari-scroll-layout.md) — Safari toolbar collapse requires document scrolling; reserve fixed inner scrolling for standalone PWAs.
