...
export function MarketingAnalytics() {
  ...
  const values = [
    ...
    ["Product clicks", data?.clicked ?? 0, "Tracked product links followed by recipients"],
  ];
  return <PageShell title="Analytics" subtitle="Real campaign activity from your configured SMTP connection">
    ...
    <div className="rounded-xl border border-amber-100 bg-amber-50 p-4 text-sm text-amber-900"><div className="flex gap-3"><BarChart3 className="h-5 w-5 shrink-0 text-amber-600" /><div><p className="font-semibold">Provider limitation</p><p className="mt-1 text-amber-800/80">Delivery, open, and unsubscribe-rate metrics are {unavailable.toLowerCase()} because SMTP responses do not include those events. Product clicks are available for links generated by this app.</p></div></div></div>
  </PageShell>;
}
