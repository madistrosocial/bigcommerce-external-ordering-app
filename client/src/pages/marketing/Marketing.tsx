...
import {
  ...
  getMarketingTemplates, searchMarketingProducts,
} from "@/lib/api";
import {
...
function CampaignEditor({ id }: { id?: number }) {
  ...
  const [form, setForm] = useState<any>({
    ...
    message_content: "<p></p>", template_id: null, audience_type: "all_eligible",
...
export function MarketingAudiences() {
  ...
  return <PageShell title="Audiences" subtitle="Build reusable CRM and imported-contact groups" action={hasPermission("marketing", "create") ? <Button onClick={startNew}><Plus className="mr-2 h-4 w-4" /> New audience</Button> : undefined}>
